...
.PHONY: github.com/b582q9/go-ipfs/test/dependencies/pollEndpoint
$(d)/pollEndpoint: github.com/b582q9/go-ipfs/test/dependencies/pollEndpoint
	$(go-build-testdep)
TGTS_$(d) += $(d)/pollEndpoint

.PHONY: github.com/b582q9/go-ipfs/test/dependencies/go-sleep
$(d)/go-sleep: github.com/b582q9/go-ipfs/test/dependencies/go-sleep
	$(go-build-testdep)
TGTS_$(d) += $(d)/go-sleep

.PHONY: github.com/b582q9/go-ipfs/test/dependencies/go-timeout
$(d)/go-timeout: github.com/b582q9/go-ipfs/test/dependencies/go-timeout
	$(go-build-testdep)
TGTS_$(d) += $(d)/go-timeout

.PHONY: github.com/b582q9/go-ipfs/test/dependencies/iptb
$(d)/iptb: github.com/b582q9/go-ipfs/test/dependencies/iptb
	$(go-build-testdep)
TGTS_$(d) += $(d)/iptb

.PHONY: github.com/b582q9/go-ipfs/test/dependencies/ma-pipe-unidir
$(d)/ma-pipe-unidir: github.com/b582q9/go-ipfs/test/dependencies/ma-pipe-unidir
	$(go-build-testdep)
TGTS_$(d) += $(d)/ma-pipe-unidir

.PHONY: github.com/b582q9/go-ipfs/test/dependencies/json-to-junit
$(d)/json-to-junit: github.com/b582q9/go-ipfs/test/dependencies/json-to-junit
	$(go-build-testdep)
